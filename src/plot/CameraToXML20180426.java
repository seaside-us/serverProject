...
public class CameraToXML20180426 {
	...
	private Logger logger = Logger.getLogger(CameraToXML20180426.class.getName());
	 ...
	 * @return
	 */
	public boolean hasExpressAndOneModel(ArrayList<String> modelNamelist, Document doc) {
		Element rootName = (Element) doc.getRootElement();
		Element name = rootName.element("maName");
		for (Iterator<Element> it = name.elementIterator(); it.hasNext();) {
			Element rule = it.next();
	...
	public static void main(String[] str) {
		CameraToXML20180426 camera = new CameraToXML20180426();
