...
public class CameraToXML20171025 {
	...
	private Logger logger = Logger.getLogger(CameraToXML20171025.class.getName());
	...
	public static void main(String[] str) {
		CameraToXML20171025 camera = new CameraToXML20171025();
