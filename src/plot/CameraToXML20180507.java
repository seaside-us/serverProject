...
public class CameraToXML20180507 {
	...
	private Logger logger = Logger.getLogger(CameraToXML20180507.class.getName());
	...
	public static void main(String[] str) {
		CameraToXML20180507 camera = new CameraToXML20180507();
