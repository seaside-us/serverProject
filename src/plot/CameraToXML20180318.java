...
public class CameraToXML20180318 {
	...
	private Logger logger = Logger.getLogger(CameraToXML20180318.class.getName());
	...
	public static void main(String[] str) {
		CameraToXML20180318 camera = new CameraToXML20180318();
