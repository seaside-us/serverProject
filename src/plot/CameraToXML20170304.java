...
public class CameraToXML20170304 {
	...
	private Logger logger = Logger.getLogger(CameraToXML20170304.class.getName());
	...
	public Document CreateCamera(OWLModel owlModel, String maName, Document doc) {
		...
		if (bgtype == 1) {
			...
			if (isBgSceneCamera(maName)) {
				logger.info("===背景摄像机的自动规划===");
	...
	public boolean isBgSceneCamera(String maName) {
	...
	public static void main(String[] str) {
		CameraToXML20170304 camera = new CameraToXML20170304();
