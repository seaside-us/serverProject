...
public class CameraToXML20171106 {
	...
	private Logger logger = Logger.getLogger(CameraToXML20171106.class.getName());
	...
	public static void main(String[] str) {
		CameraToXML20171106 camera = new CameraToXML20171106();
